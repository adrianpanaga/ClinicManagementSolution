...
namespace ClinicManagement.Data.Migrations
{
    ...
    [Migration("20250716040208_AddPatientDocumentsTableAndSeedData")]
    partial class AddPatientDocumentsTableAndSeedData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClinicManagement.Data.Models.LabResult", b =>
                {
            ...
            modelBuilder.Entity("ClinicManagement.Data.Models.PatientDocument", b =>
                {
            ...
            modelBuilder.Entity("ClinicManagement.Data.Models.StaffDetail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            StaffId = 114,
                            ContactNumber = "09324567891",
                            CreatedAt = new DateTime(2025, 6, 23, 10, 0, 0, 0, DateTimeKind.Utc),
                            Email = "allysa.dear@clinic.com",
                            FirstName = "Allysa",
                            IsDeleted = false,
            ...
            modelBuilder.Entity("ClinicManagement.Data.Models.TriageRecord", b =>
                {
            ...
            modelBuilder.Entity("ClinicManagement.Data.Models.LabResult", b =>
                {
                    ...
                    b.HasOne("ClinicManagement.Data.Models.MedicalRecord", "MedicalRecord")
                        .WithMany()
                        .HasForeignKey("MedicalRecordId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_LabResults_MedicalRecords");

                    b.HasOne("ClinicManagement.Data.Models.StaffDetail", "OrderedByStaff")
                        .WithMany()
            ...
            modelBuilder.Entity("ClinicManagement.Data.Models.PatientDocument", b =>
                {
                    ...
                    b.HasOne("ClinicManagement.Data.Models.StaffDetail", "UploadedByStaff")
                        .WithMany()
            ...
            modelBuilder.Entity("ClinicManagement.Data.Models.TriageRecord", b =>
                {
                    b.HasOne("ClinicManagement.Data.Models.Appointment", "Appointment")
                        ...
                        .HasForeignKey("AppointmentId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_TriageRecords_Appointments");
                    ...
                    b.HasOne("ClinicManagement.Data.Models.Patient", "Patient")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_TriageRecords_Patients");
